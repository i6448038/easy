package bootstrapplugin.perspectives;
 ...
 *  to change. 
 */
public class BootStrapPerspective implements IPerspectiveFactory {

	private IPageLayout factory;

	public BootStrapPerspective() {
		super();
	}
...
////		bottom.addView("bootstrapplugin.views.BootStrapView");
//		bottom.addView(IPageLayout.ID_PROBLEM_VIEW);
//		bottom.addView("bootstrapplugin.views.BootStrapView");//NON-NLS-1
//		bottom.addPlaceholder(IConsoleConstants.ID_CONSOLE_VIEW);

//	    IFolderLayout topRight=factory.createFolder("topRight", IPageLayout.RIGHT, 0.80f,factory.getEditorArea() );
//		    topRight.addView("bootstrapplugin.views.BootStrapView");
